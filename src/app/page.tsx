...
export default function Home() {
    const { kosts, isLoading, editingId, editFormData, actionLoading, setEditFormData, startAdding, startEditing, cancelEdit, handleSave, handleDelete } = useKosts();
            ...
            <main className="p-6 md:p-12 max-w-[1440px] mx-auto w-full space-y-12 flex-1">
                ...
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-12">
                    <div className="space-y-3">
                        <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-foreground">Pilih Kost</h1>
                    ...
                    <Button
                        onClick={startAdding}
                        size="lg"
                        className="rounded-xl shadow-l shadow-orange-500/10 h-12 px-4 text-sm font-bold"
                    >
