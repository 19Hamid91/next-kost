...
export default function FinancePage() {
    ...
    const { selectedMonth, selectedYear, summary, expenses, depositRows, reminders, allRooms, allTenants, isLoading, actionLoading, dismissedReminder, setDismissedReminder, prevMonth, nextMonth, addExpense, deleteExpense, refundDeposit } =
        useFinance(kostId);
        ...
        return (
            <div className="min-h-screen bg-muted/30 flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                    ...
                    <p className="text-muted-foreground text-xs font-bold uppercase tracking-[0.2em] animate-pulse">Loading Finance Data...</p>
                </div>
            </div>
        );
    }
            ...
            <main className="p-6 md:p-12 max-w-[1440px] mx-auto w-full space-y-8 flex-1">
                ...
                >
                    <div className="space-y-3">
                        <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight text-foreground">Finance</h1>
