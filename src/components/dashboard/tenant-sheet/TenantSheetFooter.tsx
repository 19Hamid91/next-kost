...
export default function TenantSheetFooter({
  mode,
  setMode,
  isBooked,
  tenantExists,
      ...
      {mode === 'sewa' && (
        <div className="flex gap-3 w-full">
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="flex-1 h-14 font-bold rounded-2xl border-amber-300 text-amber-700 hover:bg-amber-50 cursor-pointer"
          >
          ...
          <Button
            ...
            onClick={handleSewa}
            disabled={loading}
            className="flex-1 h-14 font-bold rounded-2xl shadow-xl shadow-orange-500/10 cursor-pointer"
          >
      ...
      {mode === 'view' && isBooked && (
        <div className="flex gap-3 w-full">
          <Button
            ...
            disabled={loading}
            variant="outline"
            className="flex-1 h-14 font-bold rounded-2xl text-muted-foreground cursor-pointer"
          >
            Batalkan Booking
          </Button>
          <Button
            ...
            disabled={loading}
            className="flex-1 h-14 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-2xl shadow-xl shadow-blue-500/10 cursor-pointer"
          >
      ...
      {mode === 'view' && !isBooked && tenantExists && (
        <div className="flex gap-3 w-full">
          <Button
            ...
            variant="outline"
            className="flex-1 h-14 font-bold rounded-2xl flex items-center gap-2 cursor-pointer"
          >
          ...
          <Button
            ...
            disabled={loading}
            variant="destructive"
            className="flex-1 h-14 font-bold rounded-2xl shadow-xl shadow-destructive/10 cursor-pointer"
          >
            {loading ? <Loader2 className="w-5 h-5 animate-spin mr-2" /> : null}
      ...
      {mode === 'renew' && (
        <div className="flex gap-3 w-full">
          ...
          <Button
            ...
            onClick={handleRenew}
            disabled={loading}
            className="flex-1 h-14 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl shadow-xl shadow-emerald-500/10 cursor-pointer"
          >
