        ...
        >
            <CardContent className="p-8 space-y-8">
                ...
                <div className="space-y-3">
                    <h3 className="font-bold text-xl text-foreground tracking-tight group-hover:text-primary transition-colors duration-300">{kost.Nama_Kost}</h3>
                    <div className="flex items-center gap-2.5">
                        ...
                        <span className="text-muted-foreground text-[10px] font-bold tracking-wider uppercase leading-none">{kost.Alamat || "Alamat belum diatur"}</span>
                    </div>
                </div>
            </CardContent>
        </Card>
