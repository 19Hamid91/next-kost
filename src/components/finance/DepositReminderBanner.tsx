...
export default function DepositReminderBanner({ reminders, dismissed, onDismiss, onViewDetails }: DepositReminderBannerProps) {
                    ...
                    <div className="bg-amber-500/10 border border-amber-500/30 rounded-[1.5rem] px-6 py-4 flex items-center justify-between gap-4">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-amber-700/70 mt-0.5">{reminders.map((r) => r.tenantName).join(", ")}</p>
                            </div>
                        </div>
