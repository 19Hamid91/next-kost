...
export default function RoomManagement({ rooms, editingId, editFormData, isAdding, actionLoading, selectedIds, onEdit, onSave, onDelete, onCancel, onStartAdding, onBulkAdd, onToggleSelect, setEditFormData }: RoomManagementProps) {
                                ...
                                <TableRow className="border-border bg-orange-50/30">
                                    ...
                                    <TableCell>
                                        <Input
                                            ...
                                            onChange={(e) => setEditFormData({ ...editFormData, No_Kamar: e.target.value })}
                                    ...
                                    <TableCell>
                                        <Input
                                            type="number"
                                            value={editFormData.Lantai || "1"}
                                            onChange={(e) => setEditFormData({ ...editFormData, Lantai: e.target.value })}
                                            className="h-10 rounded-xl"
                                        />
                                    </TableCell>
                                    <TableCell>
                                        <Input
                                            type="number"
                                            value={editFormData.Harga_Sewa || ""}
                                            onChange={(e) => setEditFormData({ ...editFormData, Harga_Sewa: e.target.value })}
                                            className="h-10 rounded-xl"
                                            placeholder="1500000"
                                        />
                                    </TableCell>
                                            ...
                                            {isEditing ? (
                                                ...
                                                <div className="flex justify-end gap-2">
                                                    ...
                                                    <Button
                                                        size="icon"
                                                        variant="ghost"
                                                        disabled={actionLoading === `delete-${room.ID_Kamar}`}
                                                        onClick={() => onDelete(room.ID_Kamar)}
