...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "hover:bg-zinc-50 transition-colors data-[state=selected]:bg-zinc-50",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "px-3 py-2 text-left text-[10px] font-semibold uppercase tracking-wide text-zinc-500 align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn(
      "px-3 py-2 text-sm text-zinc-900 align-middle [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
